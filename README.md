# DART Disclosure Insights (KOSPI)

유가증권시장(KOSPI) 상장기업의 DART 공시를 매일 분석해서,
중장기 펀더멘털 관점의 심층 기사를 자동 생성하고 Slack으로 배포하는 도구입니다.

## What it does

1. DART `todayRSS.xml` 수집
2. 회사-시장 매핑으로 KOSPI 공시만 필터링
...
- `dart_digest/market_filter.py`: KOSPI 필터
...
4. 문제 없으면 스케줄 실행을 사용합니다. 기본 스케줄은 `매일 18:10 KST`입니다.
...
```cron
0 18 * * * cd /Users/air/codes/dart && /Users/air/codes/dart/.venv/bin/python -m dart_digest.cli run >> /Users/air/codes/dart/data/dart_digest.log 2>&1
```
